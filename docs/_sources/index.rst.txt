====================================
Welcome to SpatialAutoDACQ repository
====================================
...
The purpose of this system is to collect neural data from rodents performing a navigational task in a large environment, where multiple cameras are required to track the animal.

Naming
------

The repository is called SpatialAutoDACQ, but the name `openEPhys_DACQ` is used frequently. This is simply a legacy name for the Python package, also used in the scripts, and will likely be updated in the future.
...
https://github.com/Barry-lab/SpatialAutoDACQ
